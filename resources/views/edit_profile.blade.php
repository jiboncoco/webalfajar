            ...
            <div style="width:85%;margin:auto" class="box box-primary">
                ...
                <form method="POST"  action="{{ url('manage_account/update_account') }}" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                      ...
                      <select id="selecttype" name="akses_type" class="form-control not-res" readonly/>
                  ...
                  <div class="form-group">
                    ...
                    <input style="background:#eee !important" type="email" name="akses_email" value="{{ $akses_edit->akses_email }}" class="form-control not-res" placeholder="Email" readonly/>
                  </div> 
                  <br>
                 ...
                 <script type="text/javascript">
                  ...
                  <script type="text/javascript">
                    ...
                    <input style="background:#eee !important" type="text" value="{{ $akses_edit->akses_code }}" name="akses_code" class="form-control not-res" maxlength="10" placeholder="NIP" onkeyup="this.value = minmaxnip(this.value, 0, 10)" readonly/>
                  ...
                  <div class="form-group">
                      ...
                      <select id="selecttype" name="akses_status_data" class="form-control not-res" readonly>
