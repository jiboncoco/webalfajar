          ...
          <div style="width:95%;margin:auto" class="box">
                ...
                <div class="box-body">
                    ...
                    @foreach($feature as $feature)
                      <tr>
                        <td>{{$i++}}</td>
                        <td>{{ $feature->dt_feature_to}}</td>
                        <td>{{ $feature->dt_feature_for}}</td>
                        <td>{{ $feature->dt_feature_text}}</td>
                        <td>{{ $feature->dt_feature_status}}</td>
                        <td>{{ $feature->dt_feature_action}}</td>
                        <td>
                        <a href="{{ url('manage_feature/edit_eature/'.$feature->id)}}"><i class="fa fa-pencil-square-o"></i> </a>
                        <a href="{{ url('manage_feature/delete_eature/'.$feature->id)}}"><i class="fa fa-trash"></i> </a>
                        </td>
                      </tr>
                    @endforeach
                    </tfoot>
