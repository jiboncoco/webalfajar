        ...
        <div class="admin-seacrh" style="height:2px;">
              ...
              <div style="width:95%;margin:auto;" class="box box-default collapsed-box box-solid">
                <div class="box-header with-border">
                  <h3 class="box-title">Edit Post Activity</h3>
                  <div class="box-tools pull-right">
                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i></button>
                  </div><!-- /.box-tools -->
                </div><!-- /.box-header -->
                <div class="box-body">             
                <form method="POST"  action="{{ url('manage_student/update_student_activity') }}" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-xs-6 col-md-4">
                    <label for="exampleInputPassword1">Student Grade</label>
                    <input type="text" value="{{$student->dt_aktivitas_grade}}" name="dt_aktivitas_grade" class="form-control not-res" readonly="true" />
                  ...
                  <div class="col-xs-6 col-md-4">
                    ...
                    <input type="text" value="{{$student->dt_aktivitas_class}}" name="dt_aktivitas_class" class="form-control not-res" readonly="true" />
                  </div>

                  <input id="namestudent" type="hidden" name="name_student" value="tk1a">   
                    <div class="col-xs-6 col-md-4">
                    <label for="exampleInputPassword1">Student Name</label>
                    <input type="text" value="{{$student->dt_aktivitas_name}}" name="dt_aktivitas_name" class="form-control not-res" readonly="true" />
                  </div>
                  </div>
                  <br>
                  ...
                  <div class="col-xs-6 col-md-4">
                    ...
                    <input type="text" value="{{$student->dt_aktivitas_nisn}}" name="dt_aktivitas_nisn" class="form-control not-res" readonly="true" />
                  </div>
                  <div class="col-xs-6 col-md-4">
                    <label for="exampleInputPassword1">Date</label>
                    <div class='input-group date' id='datetimepicker1'>
                        <input value="{{$student->dt_aktivitas_date}}" type='text' placeholder="Date" name="dt_aktivitas_date" class="form-control not-res birth_date" />
                  ...
                  <div class="row">
                      <div class="col-xs-8">
                        ...
                        <input type="text" value="{{$student->dt_aktivitas_reason}}" name="dt_aktivitas_reason" class="form-control not-res" placeholder="Reason"/>
                      </div>
                  </div>
                  <br>
