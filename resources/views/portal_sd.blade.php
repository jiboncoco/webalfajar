...
<head>
    <meta charset="utf-8">
    <title>Perguruan Tinggi AL – FAJAR BEKASI | Portal SD</title>
...
<div class="modal fade" id="myModalkepsek" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog-front">
        <div class="modal-content">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="myModalLabel">SD : Headmaster</h4>
            </div>
                <div class="modal-body-front">
                  @foreach($sd_headmas as $sdhm)
                   {!! $sdhm->feature_text !!}
                   @endforeach
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="myModalguru" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog-front">
        <div class="modal-content">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="myModalLabel">SD : Teacher</h4>
            </div>
                <div class="modal-body-front">
...
<div class="modal fade" id="myModalsiswa" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog-front">
        <div class="modal-content">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="myModalLabel">SD : Students</h4>
            </div>
                <div class="modal-body-front">
                  @foreach($sd_student as $sdstu)
                   {!! $sdstu->feature_text !!}
                   @endforeach
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="myModalalumni" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog-front">
        <div class="modal-content">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="myModalLabel">SD : Alumni</h4>
            </div>
                <div class="modal-body-front">
                  @foreach($sd_alumni as $sdalm)
                   {!! $sdalm->feature_text !!}
                   @endforeach
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="myModalkomite" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog-front">
        <div class="modal-content">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="myModalLabel">SD : Committee</h4>
            </div>
                <div class="modal-body-front">
                   @foreach($sd_commit as $sdcom)
                   {!! $sdcom->feature_text !!}
                   @endforeach
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="myModalmitra" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog-front">
        <div class="modal-content">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="myModalLabel">SD : Partnerships</h4>
            </div>
                <div class="modal-body-front">
                  @foreach($sd_partners as $sdps)
                   {!! $sdps->feature_text !!}
                   @endforeach
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="myModalprestasi" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog-front">
        <div class="modal-content">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="myModalLabel">SD : Achievement</h4>
            </div>
                <div class="modal-body-front">
                  @foreach($sd_achiev as $sdachiev)
                   {!! $sdachiev->feature_text !!}
                   @endforeach
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
...
<div class="modal fade" id="myModalekskul" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog-front">
        <div class="modal-content">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="myModalLabel">SD  : Extracurricular</h4>
            </div>
                <div class="modal-body-front">
                   @foreach($sd_extra as $sdxtra)
                   {!! $sdxtra->feature_text !!}
                   @endforeach
            </div>
            <div class="modal-footer">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <ul class="dropdown-menu sub-menu">
              <li><a data-toggle="modal" data-target="#myModalsiswa" href="#">Students</a></li>
...
<!-- content1 -->
  ...
  <div class="col-lg-6">
    <div class="input-group">
      <input type="text" class="form-control" name="search_sd" id="search_sd" placeholder="Search" required/>
      <div class="input-group-btn">
        ...
        <ul class="dropdown-menu">
          <li><a href="{{ url('portal_sd/all') }}">All</a></li>
          <li><a href="{{ url('portal_sd/news') }}">News</a></li>
          <li><a href="{{ url('portal_sd/agenda') }}">Agenda</a></li>
          <li><a href="{{ url('portal_sd/announcement') }}">Announcement </a></li>
          <li><a href="{{ url('portal_sd/article') }}">Article</a></li>
        </ul>
      </div><!-- /btn-group -->
    </div><!-- /input-group -->
  </div><!-- /.col-lg-6 -->
    ...
    @foreach($dt_blog_all_portal_sd as $dt_blog_all_portal_sd2)
    <a href="{{ url('view/'.$dt_blog_all_portal_sd2->id) }}">
    <div class="content1-box">
      <img class="cb-img" src="{{ url('images/'.$dt_blog_all_portal_sd2 ->cover_photo) }}" />
      <div class="cb-title">
      <?php
            $string = strip_tags($dt_blog_all_portal_sd2->dt_blog_title);
      ...
      <div class="cb-desc">
      <!-- {!! substr(preg_replace("/<img\s[^>]*?src\s*=\s*['\"]([^'\"]*?)['\"][^>]*?>/",'',$dt_blog_all_portal_sd2->dt_blog_text),0,400) !!}...... -->
      <?php
            $string = strip_tags($dt_blog_all_portal_sd2->dt_blog_text);
      ...
      <div class="cb-inf">
        <i class="fa fa-user"></i> {{$dt_blog_all_portal_sd2->dt_blog_create_by}} ({{$dt_blog_all_portal_sd2->dt_blog_by}})
        <p class="cb-date">
          {{$dt_blog_all_portal_sd2->created_at}}
        </p>
      </div>
    </div>
    @endforeach
...
$.ajaxSetup({
   headers: {'X-CSRF-Token': $('meta[name=csrf_token]').attr('content')}
        ...
        $("input[name='search_sd']").keyup(function(e){
            // alert('asdasd');
            setTimeout(function(){
                $('.content1-box-all').html('<div class="content1-box-all">Loading...</div>');
                $.ajax({
                    'type': 'GET',
                    'url': '{{url("search_post_sd")}}/'+$('input[name=search_sd]').val(),
