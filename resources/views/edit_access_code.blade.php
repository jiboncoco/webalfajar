        ...
        <div class="admin-seacrh" style="height:2px;">
              ...
              <div style="width:95%;margin:auto;" class="box box-default collapsed-box box-solid">
                <div class="box-header with-border">
                  <h3 class="box-title">Edit Access Code</h3>
                ...
                <form method="POST"  action="{{ url('manage_account/update_access_code') }}" enctype="multipart/form-data">
                  <br>
                  <div class="row">
                 ...
                 <script type="text/javascript">
                  function minmaxname(value, min, max) 
                  {
                    ...
                    <input type="text" value="{{ $akses_log_edit->akses_log_code }}" name="akses_log_code" class="form-control not-res" maxlength="40" placeholder="Access Code" onkeyup="this.value = minmaxname(this.value, 0, 40)" required/>
