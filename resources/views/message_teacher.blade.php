              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li class="active"><a href="{{ url('manage_message/message_teacher') }}"><i class="fa fa-inbox"></i> Inbox <span class="label label-primary pull-right">12</span></a></li>
                    ...
                    <table class="table table-hover table-striped">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="mailbox-name"><a href="{{ url('manage_message/message_teacher/read_message/sent/'.$mail->id) }}">{{ $mail->dt_mail_from }}</a></td>
