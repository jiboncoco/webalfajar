        ...
        <div class="admin-seacrh" style="height:2px;">
              ...
              <div style="width:95%;margin:auto;" class="box box-default collapsed-box box-solid">
                <div class="box-header with-border">
                  <h3 class="box-title">Master Teacher Schedule</h3>
                ...
                <form method="POST"  action="{{ url('manage_teacher/save_schedule_teacher') }}" enctype="multipart/form-data">
                  ...
                  <div class='input-group date' id='datetimepicker1'>
                    <input type='text' name="sch_year" class="form-control for_year" required/>
                  ...
                  <div  class="col-xs-8">
                    ...
                    <input type="text" name="sch_task" class="form-control not-res" placeholder="Schedule Task" required/>
          ...
          <div style="width:95%;margin:auto" class="box">
                ...
                <div class="box-body">
                   <table class="for_datatable table table-bordered table-hover">
                    ...
                    <tbody>
                    <?php $i=1; ?>
                    @foreach($teacher_sch as $teachers)
                      <tr>
                        <td>{{$i++}}</td>
                  ...
                  <div class="export">
                  <a href="{{ url('manage_teacher_sch/export_data/xls') }}"><button class="btn btn-success"><i class="fa fa-paper-plane-o"></i> xls</button></a>
                  ...
                  <a onclick="return confirm('Yakin hapus semua data teacher schedule?')" href="{{url('delete/all/data/teacher_sch')}}"><button class="btn btn-danger">Delete All</button></a>
                  @else
                  @endif
                  </div>
