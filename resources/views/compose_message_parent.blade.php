...
<section class="content-header">
        ...
        <section class="content">
          <div class="row">
              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li><a href="{{ url('manage_message/message_parent') }}"><i class="fa fa-inbox"></i> Inbox </a></li>
            ...
            <form method="POST" action="{{ url('manage_message/message_parent/send') }}" enctype="multipart/form-data">
                <div class="box-header with-border">
