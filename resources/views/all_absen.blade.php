              ...
              <br>
                <div style="width:95%;margin:auto" class="box">
                  ...
                  <div class="box-body">
                    ...
                    @foreach($dt_absens as $absens)
                        <tr>
                          ...
                          <td style="text-align:center">
                            <a href="{{ url('manage_absen/delete_all_absen/'.$absens->id)}}">
                    ...
                    <div class="export">
                      <a href="{{ url('manage_teacher/absen/export_data/xls') }}">
                        <button class="btn btn-success">
                          <i class="fa fa-paper-plane-o"></i> xls
                        
                        </button>
                      </a>
                      <a href="{{ url('manage_teacher/absen/export_data/xlsx') }}">
                        <button class="btn btn-info">
                          <i class="fa fa-paper-plane-o"></i> xlsx
                        
                        </button>
                      </a>
                      <a href="{{ url('manage_teacher/absen/export_data/csv') }}">
                  ...
                  @if(session('akses_type')== "root" || session('akses_type')== "root+" || session('akses_type')== "staff")
                      ...
                      <a onclick="return confirm('Yakin hapus semua data absen?')" href="{{url('delete/all/data/teacher_absen')}}">
