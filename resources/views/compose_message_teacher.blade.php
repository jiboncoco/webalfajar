<a href="{{ url('manage_message/message_parent') }}">@extends('app_admin')
...
<section class="content-header">
        ...
        <section class="content">
          <div class="row">
            <div class="col-md-3">
              <a href="{{ url('manage_message/message_teacher') }}" class="btn btn-primary btn-block margin-bottom">Back to Inbox</a>
            ...
            <form method="POST" action="{{ url('manage_message/message_teacher/send') }}" enctype="multipart/form-data">
                <div class="box-header with-border">
              ...
              <div style="float:left;margin-top:-45px;margin-left:10px">
                <a href="{{ url('manage_message/message_teacher') }}"><button class="btn btn-danger"><i class="fa fa-close"></i> Cancel</button></a>
              </div>
              </div><!-- /. box -->
            </div><!-- /.col -->
          </div><!-- /.row -->
