...
<head>
    <meta charset="utf-8">
    <title>Perguruan Tinggi AL – FAJAR BEKASI | Article</title>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="#newsSection">Article</a></li>
          </ul>
        </li>
...
<!-- content1 -->
  ...
  <div class="content1">
    <div class="content-s">
      ...
      <input class="fcs" name="search_article" id="search_article" placeholder="Search Article..." required/>
      </span>
      </form>
    </div>
    ...
    <div class="content1-box">
      ...
      <div class="cb-title">
      <?php
            $string = strip_tags($dt_blog_all_artikel2->dt_blog_title);
...
$.ajaxSetup({
   headers: {'X-CSRF-Token': $('meta[name=csrf_token]').attr('content')}
        ...
        $("input[name='search_article']").keyup(function(e){
            // alert('asdasd');
            setTimeout(function(){
                $('.content1-box-all').html('<div class="content1-box-all">Loading...</div>');
                $.ajax({
                    'type': 'GET',
                    'url': '{{url("search_article")}}/'+$('input[name=search_article]').val(),
