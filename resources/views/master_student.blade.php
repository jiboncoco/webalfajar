      ...
      <div class="content-wrapper">
        ...
        <div class="admin-seacrh" style="height:2px;">
              ...
              <div style="width:95%;margin:auto;" class="box box-default collapsed-box box-solid">
                ...
                <form method="POST"  action="{{ url('manage_student/save_master_student') }}" enctype="multipart/form-data">
                  <div class="row">
                 ...
                 <script type="text/javascript">
                  function minmaxnip(value, min, max) 
                  {
                    ...
                    <input type="text" name="dt_student_nisn" class="form-control not-res" maxlength="50" placeholder="NISN" onkeyup="this.value = minmaxnip(this.value, 0, 50)" required/>
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                  </div>
                  <div class="col-xs-6 col-md-4">
                      <label for="exampleInputPassword1">Gender</label>
                      <select id="selecttype" name="dt_student_gender" class="form-control not-res">
                 ...
                 <script type="text/javascript">
                  function minmaxname(value, min, max) 
                  {
                    ...
                    <input type="text" name="dt_student_fname" class="form-control not-res" maxlength="50" placeholder="First Name" onkeyup="this.value = minmaxname(this.value, 0, 50)" required/>
                  </div>
                  <div class="col-xs-6 col-md-4">
                 <script type="text/javascript">
                  function minmaxname(value, min, max) 
                  {
                    ...
                    <input type="text" name="dt_student_lname" class="form-control not-res" maxlength="50" placeholder="Last Name" onkeyup="this.value = minmaxname(this.value, 0, 50)" required/>
                  </div>
                  </div>
                  <br>
                  ...
                  <div class="col-xs-6 col-md-4">
                    ...
                    <input type="text" name="dt_student_contact" class="form-control not-res" placeholder="Contact"/>
                  </div>
                  <div class="col-xs-6 col-md-4">
                    <label for="exampleInputPassword1">Email</label>
                    <input type="email" name="dt_student_email" class="form-control not-res" placeholder="Email" required/>
                  </div>
                  <div class="col-xs-2">
                  ...
                  <div class="row">
                      <div class="col-xs-8">
                        ...
                        <input type="text" name="dt_student_address" class="form-control not-res" placeholder="Address"/>
                      </div>
                  </div>
                  <br>
                  ...
                  <div class="row">
                      <div class="col-xs-6 col-md-4">
                        ...
                        <input type="file" name="dt_student_name_img" class="form-control not-res" placeholder="Photo"/>
                      </div>
                  <div class="col-xs-6 col-md-4">
                      <label for="exampleInputPassword1">Status Log</label>
                      <select id="selecttype" name="dt_student_statuslog" class="form-control not-res">
...
<!--               <form method="POST" action="{{ url('manage_student/import_data_student') }}" enctype="multipart/form-data">
          ...
          <div style="width:95%;margin:auto" class="box">
                ...
                <div class="box-body">
                  ...
                  <a onclick="return confirm('Yakin hapus semua data student?')" href="{{url('delete/all/data/student')}}"><button class="btn btn-danger">Delete All</button></a>
                  @else
                  @endif
                  </div>
