...
<head>
    <meta charset="utf-8">
    <title>Perguruan Islam Al – Fajar Bekasi | Portal SMA</title>
...
<div class="modal fade" id="myModalkepsek" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog-front">
        <div class="modal-content">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="myModalLabel">SMA : Headmaster</h4>
            </div>
                <div class="modal-body-front">
                   @foreach($sma_headmas as $smahm)
                   {!! $smahm->feature_text !!}
                   @endforeach
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="myModalguru" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog-front">
        <div class="modal-content">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="myModalLabel">SMA : Teacher</h4>
            </div>
                <div class="modal-body-front">
...
<div class="modal fade" id="myModalsiswa" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog-front">
        <div class="modal-content">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="myModalLabel">SMA : Students</h4>
            </div>
                <div class="modal-body-front">
                   @foreach($sma_student as $smastu)
                   {!! $smastu->feature_text !!}
                   @endforeach
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="myModalalumni" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog-front">
        <div class="modal-content">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="myModalLabel">SMA : Alumni</h4>
            </div>
                <div class="modal-body-front">
                   @foreach($sma_alumni as $smaalm)
                   {!! $smaalm->feature_text !!}
                   @endforeach
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="myModalkomite" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog-front">
        <div class="modal-content">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="myModalLabel">SMA : Committee</h4>
            </div>
                <div class="modal-body-front">
                   @foreach($sma_commit as $smacom)
                   {!! $smacom->feature_text !!}
                   @endforeach
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="myModalmitra" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog-front">
        <div class="modal-content">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="myModalLabel">SMA : Partnerships</h4>
            </div>
                <div class="modal-body-front">
                   @foreach($sma_partners as $smaps)
                   {!! $smaps->feature_text !!}
                   @endforeach
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="myModalprestasi" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog-front">
        <div class="modal-content">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="myModalLabel">SMA : Achievement</h4>
            </div>
                <div class="modal-body-front">
                   @foreach($sma_achiev as $smaachiev)
                   {!! $smaachiev->feature_text !!}
                   @endforeach
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
...
<div class="modal fade" id="myModalekskul" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog-front">
        <div class="modal-content">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="myModalLabel">SMA  : Extracurricular</h4>
            </div>
                <div class="modal-body-front">
                   @foreach($sma_extra as $smaxtra)
                   {!! $smaxtra->feature_text !!}
                   @endforeach
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
...
<!-- content1 -->
  ...
  <div class="col-lg-6">
    <div class="input-group">
      <input type="text" class="form-control" name="search_sma" id="search_sma" placeholder="Search" required/>
    ...
    @foreach($dt_blog_portal_sma as $dt_blog_portal_sma2)
    <a href="{{ url('view/'.$dt_blog_portal_sma2->id) }}">
    <div class="content1-box">
      <img class="cb-img" src="{{ url('images/'.$dt_blog_portal_sma2->cover_photo) }}" />
      <div class="cb-title">
      <?php
            $string = strip_tags($dt_blog_portal_sma2->dt_blog_title);
      ...
      <div class="cb-desc">
      <!-- {!! substr(preg_replace("/<img\s[^>]*?src\s*=\s*['\"]([^'\"]*?)['\"][^>]*?>/",'',$dt_blog_portal_sma2->dt_blog_text),0,400) !!}...... -->
      <?php
            $string = strip_tags($dt_blog_portal_sma2->dt_blog_text);
      ...
      <div class="cb-inf">
        <i class="fa fa-user"></i> {{$dt_blog_portal_sma2->dt_blog_create_by}} ({{$dt_blog_portal_sma2->dt_blog_by}})
        <p class="cb-date">
          {{$dt_blog_portal_sma2->created_at}}
        </p>
      </div>
    </div>
    @endforeach
...
$.ajaxSetup({
   headers: {'X-CSRF-Token': $('meta[name=csrf_token]').attr('content')}
        ...
        $("input[name='search_sma']").keyup(function(e){
            // alert('asdasd');
            setTimeout(function(){
