        ...
        <div class="admin-seacrh" style="height:2px;">
              ...
              <div style="width:95%;margin:auto;" class="box box-default collapsed-box box-solid">
                <div class="box-header with-border">
                  <h3 class="box-title">Edit Master Type Post</h3>
                ...
                <form method="POST"  action="{{ url('manage_post/update_master_type_post') }}" enctype="multipart/form-data">
                  <br>
                  <div class="row">
                 ...
                 <script type="text/javascript">
                  function minmaxname(value, min, max) 
                  {
                    ...
                    <input value="{{ $m_blogs->m_blog_name_type }}" type="text" name="m_blog_name_type" class="form-control not-res" maxlength="40" placeholder="Type Post" onkeyup="this.value = minmaxname(this.value, 0, 40)" required/>
                    <input type="hidden" name="id" value="{{ $m_blogs->id }}">
                  ...
                  <div class="col-xs-6 col-md-4">
                      ...
                      <select id="selecttype" name="m_blog_status" class="form-control not-res">
                        @if($m_blogs->m_blog_status == "active")
                        <option value="active" selected>Active</option>
                        <option value="disable">Disable</option> 
                        @elseif($m_blogs->m_blog_status == "disable")
                  ...
                  <br><br>
                    ...
                    <a href="{{ url('manage_post/master_type_post') }}"><button class="btn btn-danger">Cancel</button></a>
                </form>                </div><!-- /.box-body -->
              </div><!-- /.box -->
