...
<div class="row">
            <div class="col-md-3">
              <a href="{{ url('manage_message/message_student') }}" class="btn btn-primary btn-block margin-bottom">Compose</a>
              ...
              <div class="box box-primary">
                ...
                <div class="box-footer">
                  <div class="pull-right">
                    <a href="{{ url('manage_message/message_student/compose') }}"><button class="btn btn-default"><i class="fa fa-reply"></i> Reply</button></a>
