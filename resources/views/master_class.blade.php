      ...
      <div class="content-wrapper">
        ...
        <div class="admin-seacrh" style="height:2px;">
              ...
              <div style="width:95%;margin:auto;" class="box box-default collapsed-box box-solid">
                ...
                <form method="POST"  action="{{ url('manage_class/save_class') }}" enctype="multipart/form-data">
                  <br>
                  <div class="row">
                  <div class="col-xs-8">
                 ...
                 <script type="text/javascript">
                  function minmaxname(value, min, max) 
                  {
                    ...
                    <input type="text" name="dt_kelas_name" class="form-control not-res" maxlength="40" placeholder="Type Post" onkeyup="this.value = minmaxname(this.value, 0, 40)" required/>
...
<!--               <form method="POST" action="{{ url('manage_teacher/import_data_teacher') }}" enctype="multipart/form-data">
          ...
          <div style="width:95%;margin:auto" class="box">
                ...
                <div class="box-body">
                  ...
                  <div class="export">
                  <a href="{{ url('manage_class/export_data/xls') }}"><button class="btn btn-success"><i class="fa fa-paper-plane-o"></i> xls</button></a>
                  ...
                  <a onclick="return confirm('Yakin hapus semua data kelas?')" href="{{url('delete/all/data/kelas')}}"><button class="btn btn-danger">Delete All</button></a>
                  @else
                  @endif
                  </div>
