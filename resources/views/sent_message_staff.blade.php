                    ...
                    <table class="table table-hover table-striped">
                      <tbody>
                        ...
                        <tr>
                          ...
                          @if(session('akses_type') == 'staff')
                          <td class="mailbox-name"><a href="{{ url('manage_message/message_staff/read_message/sent/'.$mail->id) }}">{{ $mail->dt_mail_to }}</a></td>
                          @elseif(session('akses_type') == 'root')
                          <td class="mailbox-name"><a href="{{ url('manage_message/message_root/read_message/sent/'.$mail->id) }}">{{ $mail->dt_mail_to }}</a></td>
                          @elseif(session('akses_type') == 'root+')
                          <td class="mailbox-name"><a href="{{ url('manage_message/message_root+/read_message/sent/'.$mail->id) }}">{{ $mail->dt_mail_to }}</a></td>
                          @endif
