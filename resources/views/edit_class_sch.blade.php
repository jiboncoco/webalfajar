        ...
        <div class="admin-seacrh" style="height:2px;">
              ...
              <div style="width:95%;margin:auto;" class="box box-default collapsed-box box-solid">
                <div class="box-header with-border">
                  <h3 class="box-title">Edit Master Class Schedule</h3>
                ...
                <form method="POST"  action="{{ url('manage_class/update_schedule_class') }}" enctype="multipart/form-data">
                  ...
                  <div class='input-group date' id='datetimepicker1'>
                    <input value="{{ $class_sch_edit->sch_class_year }}" type='text' name="sch_class_year" class="form-control for_year" required/>
                  ...
                  <div class='input-group date' id='datetimepicker1'>
                    <input value="{{ $class_sch_edit->sch_class_time }}" type='text' name="sch_class_time" class="form-control for_time" />
                      <span class="input-group-addon">
                      <span class="glyphicon glyphicon-calendar"></span>
                      </span>
                  </div>
                  ...
                  <div  class="col-xs-6 col-md-4">
                    ...
                    <input value="{{ $class_sch_edit->sch_class_schedule }}"t type="text" name="sch_class_schedule" class="form-control" placeholder="Schedule Task" required/>
                    <input type="hidden" name="id" value="{{ $class_sch_edit->id }}">
                ...
                <div style="margin-top:-54px;margin-left:80px">
                    <a href="{{ url('manage_class/master_schedule_class') }}"><button class="btn btn-danger">Cancel</button></a>
                </div> 
                </div><!-- /.box-body -->
              </div><!-- /.box -->
